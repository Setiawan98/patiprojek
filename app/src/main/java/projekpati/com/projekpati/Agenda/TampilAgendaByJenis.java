...
public class TampilAgendaByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_agenda_by_jenis);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilAgendaByJenis.this, DetilAgenda.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilAgendaByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_agenda");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<AgendaModel> call = api.cariAgendaByJenis(kategori);
        ...
        call.enqueue(new Callback<AgendaModel>() {
            ...
            public void onResponse(Call<AgendaModel> call, final Response<AgendaModel> response) {
                ...
                listView.setAdapter(new AgendaAdapter(TampilAgendaByJenis.this, R.layout.agenda_adapter, list));
                Toast.makeText(TampilAgendaByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<AgendaModel> call, Throwable t) {
                Toast.makeText(TampilAgendaByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
