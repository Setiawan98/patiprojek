...
public class DataSaringOlahragaActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListOlahraga> list = new ArrayList<>();
    List<ListOlahraga> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_olahraga);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringOlahragaActivity.this, DetilOlahraga.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<OlahragaModel>() {
                ...
                public void onResponse(Call<OlahragaModel> call, final Response<OlahragaModel> response) {
                    ...
                    listView.setAdapter(new OlahragaAdapter(DataSaringOlahragaActivity.this, R.layout.olahraga_adapter, list));
                    Toast.makeText(DataSaringOlahragaActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<OlahragaModel> call, Throwable t) {
                    Toast.makeText(DataSaringOlahragaActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<OlahragaModel> call = api.cariOlahragabyAPI(namasaring);
            call.enqueue(new Callback<OlahragaModel>() {
                @Override
