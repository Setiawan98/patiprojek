...
public class DataSaringBankActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListBank> list = new ArrayList<>();
    List<ListBank> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_bank);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringBankActivity.this, DetilBank.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<BankModel>() {
                ...
                public void onResponse(Call<BankModel> call, final Response<BankModel> response) {
                    ...
                    listView.setAdapter(new BankAdapter(DataSaringBankActivity.this, R.layout.bank_adapter, list));
                    Toast.makeText(DataSaringBankActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<BankModel> call, Throwable t) {
                    Toast.makeText(DataSaringBankActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<BankModel> call = api.cariBankbyAPI(namasaring);
            call.enqueue(new Callback<BankModel>() {
                @Override
