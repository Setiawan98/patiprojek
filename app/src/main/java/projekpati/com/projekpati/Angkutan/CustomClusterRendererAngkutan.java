...
public class CustomClusterRendererAngkutan extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererAngkutan(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
