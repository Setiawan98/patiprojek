...
import projekpati.com.projekpati.Agenda.DataSaringAgendaActivity;
...
public class DataSaringAgendaActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListAgenda> list = new ArrayList<>();
    List<ListAgenda> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_agenda);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringAgendaActivity.this, DetilAgenda.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<AgendaModel>() {
                ...
                public void onResponse(Call<AgendaModel> call, final Response<AgendaModel> response) {
                    ...
                    listView.setAdapter(new AgendaAdapter(DataSaringAgendaActivity.this, R.layout.agenda_adapter, list));
                    Toast.makeText(DataSaringAgendaActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<AgendaModel> call, Throwable t) {
                    Toast.makeText(DataSaringAgendaActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<AgendaModel> call = api.cariAgendabyAPI(namasaring);
            call.enqueue(new Callback<AgendaModel>() {
                @Override
    ...
    public void loadmore() {
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<AgendaModel> a = api.loadMoreAgenda(String.valueOf(nextPage));
        a.enqueue(new Callback<AgendaModel>() {
