...
public class MenuBioskop extends AppCompatActivity {
    ListView listView;
    EditText cari;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final BottomNavigationView bottomNavigationView = findViewById(R.id.menuBioskop);
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(id==R.id.beranda){
                    DataBioskopFragment first = new DataBioskopFragment();
                    openFragment(first);
                    //status =1;
