...
public class PelelanganIkanModel {
    String status, judul, key, waktu, icon;
    Integer jumlah_data, halaman_selanjutnya;
    Map<String, ListPelelanganIkan> data;

    public PelelanganIkanModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListPelelanganIkan> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListPelelanganIkan> getData() {
        return data;
    }

    public void setData(Map<String, ListPelelanganIkan> data) {
        this.data = data;
    }
}
