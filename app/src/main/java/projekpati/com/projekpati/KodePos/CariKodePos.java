...
public class CariKodePos extends AppCompatActivity {
    EditText textCari;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.listKodePos);

        imageBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CariKodePos.this, MenuKodePos.class);
        ...
        textCari.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    performSearch();
                    hideSoftKeyboard(CariKodePos.this);
                    return true;
                }
                return false;
            }
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage == 0) {
                            Toast.makeText(CariKodePos.this, "No More Data", Toast.LENGTH_SHORT).show();
                        } else {
                            loadMoreData();
                        }
        ...
        buttonImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<KodePosModel> call = api.cariKodePosbyAPI(textCari.getText().toString());
                call.enqueue(new Callback<KodePosModel>() {
                    @Override
                    public void onResponse(Call<KodePosModel> call, Response<KodePosModel> response) {
                        ...
                        listView.setAdapter(new KodePosAdapter(CariKodePos.this, R.layout.kode_pos_adapter, list));
                        Toast.makeText(CariKodePos.this.getApplicationContext(), "Ditemukan", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(Call<KodePosModel> call, Throwable t) {
                        Toast.makeText(CariKodePos.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent = new Intent(CariKodePos.this,DetilKodePos.class);
    ...
    public void loadMoreData(){
        ...
        call.enqueue(new Callback<KodePosModel>() {
            ...
            public void onResponse(Call<KodePosModel> call, final Response<KodePosModel> response) {
                ...
                KodePosAdapter adapter = new KodePosAdapter(CariKodePos.this, R.layout.kode_pos_adapter, list);
                listView.setAdapter(adapter);
                adapter.notifyDataSetChanged();
                Toast.makeText(CariKodePos.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
