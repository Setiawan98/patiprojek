 ...
 */
public class TambahBioskopFragment extends Fragment implements OnMapReadyCallback, LocationListener{


    public TambahBioskopFragment() {
    ...
    public void addKuliner(){
        ...
        Call<DetilBioskopBaru> call = api.addDataBioskop(nama,telp,email,website,deskripsi,latitude,longitude,"0",value);
