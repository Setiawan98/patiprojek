...
public class KodePosModel {
    ...
    Map<String, ListKodePos> data;

    public KodePosModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListKodePos> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListKodePos> getData() {
        return data;
    }

    public void setData(Map<String, ListKodePos> data) {
        this.data = data;
    }
}
