...
import projekpati.com.projekpati.Aspirasi.DetilAspirasi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilAgenda.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else {
