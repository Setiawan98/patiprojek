...
public class TambahBankFragment extends Fragment implements OnMapReadyCallback, LocationListener{
    ...
    public void addBankWithGambar(){
        ...
        MultipartBody.Part gambarBank1=null;
        MultipartBody.Part gambarBank2=null;
        MultipartBody.Part gambarBank3=null;
        if(imageBytes1!=null)
        {
            gambarBank1 = MultipartBody.Part.createFormData("gambar", "a.jpg", requestFile1);
            gambarBankUtama = MultipartBody.Part.createFormData("gambarutama", "a.jpg", requestFile1);
            Log.d("masuk","1");
        }else{
            Log.d("nullImage","1");
        }
        if(imageBytes2!=null)
        {
            gambarBank2 = MultipartBody.Part.createFormData("gambar2", "b.jpg", requestFile2);
            Log.d("masuk","2");
        }else{
            Log.d("nullImage","2");
        }
        if(imageBytes3!=null)
        {
            gambarBank3 = MultipartBody.Part.createFormData("gambar3", "c.jpg", requestFile3);
            Log.d("masuk","3");
        }else{
            Log.d("nullImage","3");
        }

        Call<DetilBankBaru> call = api.addDataBankWithGambar(gambarBank1,gambarBank2,gambarBank3,gambarBankUtama,nama,telp,email,website,deskripsi,latitude,longitude,userId,value);
