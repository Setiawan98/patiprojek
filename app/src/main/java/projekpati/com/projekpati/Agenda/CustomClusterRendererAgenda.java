...
public class CustomClusterRendererAgenda extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererAgenda(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
