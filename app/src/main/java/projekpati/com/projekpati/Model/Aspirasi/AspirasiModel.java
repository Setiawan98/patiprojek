...
public class AspirasiModel {
    ...
    Map<String, ListAspirasi> data;

    public AspirasiModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListAspirasi> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListAspirasi> getData() {
        return data;
    }

    public void setData(Map<String, ListAspirasi> data) {
        this.data = data;
    }
}
