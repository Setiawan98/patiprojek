...
public class CustomClusterRendererPolisi extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererPolisi(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
