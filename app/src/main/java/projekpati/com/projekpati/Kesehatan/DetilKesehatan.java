...
import projekpati.com.projekpati.Model.Kesehatan.GambarKesehatanDetil;
...
public class DetilKesehatan extends AppCompatActivity {
    ...
    float lat;
    float longt;
    LinearLayout listKesehatan;
    LinearLayout linearDetil, linearJam;
    List<KomentarParent> list = new ArrayList<>();
    List<DetilKesehatanBaru> Menu = new ArrayList<>();
    List<GambarKesehatanDetil> gambarList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detil_kesehatan);
        ...
        listKesehatan = findViewById(R.id.listKesehatan);
        ...
        id = bundle.getString("id_kesehatan");
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilKesehatan.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else {
                    final Bundle bundle = getIntent().getExtras();
                    final String id = bundle.getString("id_kesehatan");
                    final float hasil = ratingstar.getRating();
                    isi = komentar.getText().toString();

                    API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
                    Call<postKomentar> call = api.addKomentar(id, "kesehatan", nama, email, telp, website, isi, String.valueOf(hasil), userid);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasKesehatan( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
    ...
    public void getDataDetail(){
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<DetilKesehatanModel> call = api.detailKesehatan(id);

        call.enqueue(new Callback<DetilKesehatanModel>() {
            @Override
            public void onResponse(Call<DetilKesehatanModel> call, Response<DetilKesehatanModel> response) {


                Log.w("ResponseAsu", new Gson().toJson(response.body()));
                title.setText(response.body().getJudul());
                refnama.setText(response.body().getData().getRef_kesehatan_nama());
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_kesehatan_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilKesehatan.this,stringArray);
            ...
            @Override
            public void onFailure(Call<DetilKesehatanModel> call, Throwable t) {
    ...
    public void getKomentar(){
        Toast.makeText(DetilKesehatan.this.getApplicationContext(),id, Toast.LENGTH_SHORT).show();
        API api2 = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KomentarLengkap> call2 = api2.getKomentarKesehatan(id);
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilKesehatan.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listKesehatan.addView(adapter,0);
                listKesehatan.invalidate();
            }
        },2000);
