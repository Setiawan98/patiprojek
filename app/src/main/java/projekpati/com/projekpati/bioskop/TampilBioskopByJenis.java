...
public class TampilBioskopByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_bioskop_by_jenis);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilBioskopByJenis.this, DetilBioskop.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilBioskopByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_bioskop");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<BioskopModel> call = api.cariBioskopByJenis(kategori);
        ...
        call.enqueue(new Callback<BioskopModel>() {
            ...
            public void onResponse(Call<BioskopModel> call, final Response<BioskopModel> response) {
                ...
                listView.setAdapter(new BioskopAdapter(TampilBioskopByJenis.this, R.layout.bioskop_adapter, list));
                Toast.makeText(TampilBioskopByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<BioskopModel> call, Throwable t) {
                Toast.makeText(TampilBioskopByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
