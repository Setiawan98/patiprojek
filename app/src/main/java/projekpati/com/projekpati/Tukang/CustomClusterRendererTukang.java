...
public class CustomClusterRendererTukang extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererTukang(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
