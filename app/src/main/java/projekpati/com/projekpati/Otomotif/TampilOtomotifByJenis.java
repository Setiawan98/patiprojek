...
public class TampilOtomotifByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_otomotif_by_jenis);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilOtomotifByJenis.this,DetilOtomotif.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilOtomotifByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_otomotif");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<OtomotifModel> call = api.cariOtomotifByJenis(kategori);
        ...
        call.enqueue(new Callback<OtomotifModel>() {
            ...
            public void onResponse(Call<OtomotifModel> call, final Response<OtomotifModel> response) {
                ...
                listView.setAdapter(new OtomotifAdapter(TampilOtomotifByJenis.this, R.layout.otomotif_adapter, list));
                Toast.makeText(TampilOtomotifByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<OtomotifModel> call, Throwable t) {
                Toast.makeText(TampilOtomotifByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
