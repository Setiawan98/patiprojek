...
public class DataSaringBioskopActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListBioskop> list = new ArrayList<>();
    List<ListBioskop> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_bioskop);

        toolbar = findViewById(R.id.bioskopToolbar);
        listView = (ListView) findViewById(R.id.listBioskop);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringBioskopActivity.this, DetilBioskop.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            Call<BioskopModel> call = api.tampilSemuaBioskop();
            ...
            call.enqueue(new Callback<BioskopModel>() {
                ...
                public void onResponse(Call<BioskopModel> call, final Response<BioskopModel> response) {
                    ...
                    listView.setAdapter(new BioskopAdapter(DataSaringBioskopActivity.this, R.layout.bioskop_adapter, list));
                    Toast.makeText(DataSaringBioskopActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<BioskopModel> call, Throwable t) {
                    Toast.makeText(DataSaringBioskopActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<BioskopModel> call = api.cariBioskopbyAPI(namasaring);
            call.enqueue(new Callback<BioskopModel>() {
                @Override
    ...
    public void loadmore() {
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<BioskopModel> a = api.loadMoreBioskop(String.valueOf(nextPage));
        a.enqueue(new Callback<BioskopModel>() {
