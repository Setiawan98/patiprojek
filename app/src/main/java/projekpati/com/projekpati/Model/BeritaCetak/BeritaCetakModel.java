...
public class BeritaCetakModel {
    String status, judul, key, waktu, icon;
    Integer jumlah_data, halaman_selanjutnya;
    Map<String, ListBeritaCetak> data;

    public BeritaCetakModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListBeritaCetak> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListBeritaCetak> getData() {
        return data;
    }

    public void setData(Map<String, ListBeritaCetak> data) {
        this.data = data;
    }
}
