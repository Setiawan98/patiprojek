...
public class BeritaOnlineModel {

    String status, judul, key, waktu, icon;
    Integer jumlah_data, halaman_selanjutnya;
    Map<String, ListBeritaOnline> data;


    public BeritaOnlineModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListBeritaOnline> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListBeritaOnline> getData() {
        return data;
    }
}
