 ...
 */
public class TambahPelelanganIkanFragment extends Fragment implements OnMapReadyCallback, LocationListener {


    public TambahPelelanganIkanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tambah_pelelangan_ikan, container, false);
        vg=container;
    ...
    public void addPelelanganIkan(){
        ...
        Call<DetilPelelanganIkanBaru> call = api.addDataPelelanganIkan(nama,pemilik,telp,email,website,deskripsi,latitude,longitude,"0",value);
    ...
    public void addPelelanganIkanWithGambar(){
        //defining a progress dialog to show while signing up
        final ProgressDialog progressDialog = new ProgressDialog(getContext());
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        ...
        MultipartBody.Part gambarPelelanganIkan1=null;
        MultipartBody.Part gambarPelelanganIkan2=null;
        MultipartBody.Part gambarPelelanganIkan3=null;
        if(imageBytes1!=null)
        {
            gambarPelelanganIkan1 = MultipartBody.Part.createFormData("gambar", "a.jpg", requestFile1);
            gambarPelelanganIkanUtama = MultipartBody.Part.createFormData("gambarutama", "a.jpg", requestFile1);
            Log.d("masuk","1");
        }else{
            Log.d("nullImage","1");
        }
        if(imageBytes2!=null)
        {
            gambarPelelanganIkan2 = MultipartBody.Part.createFormData("gambar2", "b.jpg", requestFile2);
            Log.d("masuk","2");
        }else{
            Log.d("nullImage","2");
        }
        if(imageBytes3!=null)
        {
            gambarPelelanganIkan3 = MultipartBody.Part.createFormData("gambar3", "c.jpg", requestFile3);
            Log.d("masuk","3");
        }else{
            Log.d("nullImage","3");
        }

        Call<DetilPelelanganIkanBaru> call = api.addDataPelelanganIkanWithGambar(gambarPelelanganIkan1,gambarPelelanganIkan2,gambarPelelanganIkan3,gambarPelelanganIkanUtama,nama,pemilik,telp,email,website,deskripsi,latitude,longitude,userId,value);
