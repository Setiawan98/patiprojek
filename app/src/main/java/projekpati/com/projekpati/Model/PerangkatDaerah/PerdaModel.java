...
public class PerdaModel {
    String status, judul, key, waktu, icon;
    Integer jumlah_data, halaman_selanjutnya;
    Map<String, ListPerda> data;

    public PerdaModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListPerda> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListPerda> getData() {
        return data;
    }

    public void setData(Map<String, ListPerda> data) {
        this.data = data;
    }
}
