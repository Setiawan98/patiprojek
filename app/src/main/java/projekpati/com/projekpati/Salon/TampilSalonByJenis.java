...
public class TampilSalonByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_salon_by_jenis);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilSalonByJenis.this,DetilSalon.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilSalonByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_salon");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<SalonModel> call = api.cariSalonByJenis(kategori);
        ...
        call.enqueue(new Callback<SalonModel>() {
            ...
            public void onResponse(Call<SalonModel> call, final Response<SalonModel> response) {
                ...
                listView.setAdapter(new SalonAdapter(TampilSalonByJenis.this, R.layout.salon_adapter, list));
                Toast.makeText(TampilSalonByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<SalonModel> call, Throwable t) {
                Toast.makeText(TampilSalonByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
