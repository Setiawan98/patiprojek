...
public class CustomClusterRendererOlahraga extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererOlahraga(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
