...
public class DetilTukang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detil_tukang);
        ...
        listTukang = findViewById(R.id.listTukang);
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilTukang.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    final Bundle bundle = getIntent().getExtras();
                    final String id = bundle.getString("id_tukang");
                    final float hasil = ratingstar.getRating();
                    isi = komentar.getText().toString();

                    API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
                    Call<postKomentar> call = api.addKomentar( id, "tukang",nama, email, telp, website, isi, String.valueOf(hasil), userid);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditTukang editTukang = new EditTukang();
                editTukang.setArguments(bundle);
                fragmentTransaction.replace(R.id.fragmentEdit, editTukang);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasTukang( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
        ...
        call.enqueue(new Callback<DetilTukangModel>() {
            ...
            public void onResponse(Call<DetilTukangModel> call, Response<DetilTukangModel> response) {
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_tukang_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilTukang.this,stringArray);
    ...
    public void getKomentar(){
        Toast.makeText(DetilTukang.this.getApplicationContext(),id, Toast.LENGTH_SHORT).show();
        API api2 = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KomentarLengkap> call2 = api2.getKomentarTukang(id);
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilTukang.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listTukang.addView(adapter,0);
                listTukang.invalidate();
            }
        },2000);
