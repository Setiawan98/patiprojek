...
public class CustomClusterRendererOtomotif extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererOtomotif(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
