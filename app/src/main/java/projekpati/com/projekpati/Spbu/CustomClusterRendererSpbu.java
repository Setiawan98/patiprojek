...
public class CustomClusterRendererSpbu extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererSpbu(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
