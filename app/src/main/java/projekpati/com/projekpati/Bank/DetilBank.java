...
import projekpati.com.projekpati.Model.Bank.GambarBankDetil;
...
public class DetilBank extends AppCompatActivity {
    ...
    List<DetilBankBaru> Menu = new ArrayList<>();
    List<GambarBankDetil> gambarList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detil_bank);
        ...
        listBank = findViewById(R.id.listBank);
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilBank.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else {
                    final Bundle bundle = getIntent().getExtras();
                    final String id = bundle.getString("id_bank");
                    final float hasil = ratingstar.getRating();
                    isi = komentar.getText().toString();

                    API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
                    Call<postKomentar> call = api.addKomentar(id, "bank", nama, email, telp, website, isi, String.valueOf(hasil), userid);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasBank( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
    ...
    public void getDataDetail(){
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<DetilBankModel> call = api.detailBank(id);

        call.enqueue(new Callback<DetilBankModel>() {
            @Override
            public void onResponse(Call<DetilBankModel> call, Response<DetilBankModel> response) {
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_bank_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilBank.this,stringArray);
            ...
            @Override
            public void onFailure(Call<DetilBankModel> call, Throwable t) {
    ...
    public void getKomentar(){
        Toast.makeText(DetilBank.this.getApplicationContext(),id, Toast.LENGTH_SHORT).show();
        API api2 = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KomentarLengkap> call2 = api2.getKomentarBank(id);
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilBank.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
