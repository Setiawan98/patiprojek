...
public class TambahSalonFragment extends Fragment implements OnMapReadyCallback, LocationListener {
    ...
    public void addSalonWithGambar(){
        ...
        MultipartBody.Part gambarSalon1=null;
        MultipartBody.Part gambarSalon2=null;
        MultipartBody.Part gambarSalon3=null;
        if(imageBytes1!=null)
        {
            gambarSalon1 = MultipartBody.Part.createFormData("gambar", "a.jpg", requestFile1);
            gambarSalonUtama = MultipartBody.Part.createFormData("gambarutama", "a.jpg", requestFile1);
            Log.d("masuk","1");
        }else{
            Log.d("nullImage","1");
        }
        if(imageBytes2!=null)
        {
            gambarSalon2 = MultipartBody.Part.createFormData("gambar2", "b.jpg", requestFile2);
            Log.d("masuk","2");
        }else{
            Log.d("nullImage","2");
        }
        if(imageBytes3!=null)
        {
            gambarSalon3 = MultipartBody.Part.createFormData("gambar3", "c.jpg", requestFile3);
            Log.d("masuk","3");
        }else{
            Log.d("nullImage","3");
        }

        Call<DetilSalonBaru> call = api.addDataSalonWithGambar(gambarSalon1,gambarSalon2,gambarSalon3,gambarSalonUtama,nama,telp,email,website,deskripsi,latitude,longitude,userId,value);
