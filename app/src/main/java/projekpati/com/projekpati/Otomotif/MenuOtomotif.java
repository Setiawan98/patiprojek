...
public class MenuOtomotif extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_otomotif);
       ...
       // getIconImage();
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(id==R.id.beranda){
                    DataOtomotifFragment first = new DataOtomotifFragment();
                    openFragment(first);
                    //status =1;
                    ...
                    if(userid.equals(""))
                    {
                        Toast.makeText(MenuOtomotif.this,"Silahkan login terlebih dahulu untuk tambah data",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
...
//                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(MenuOtomotif.this, CariOtomotif.class);
            startActivity(intent);

        }
        else if(id==android.R.id.home)
        {
            Intent i = new Intent(MenuOtomotif.this, MainActivity.class);
            startActivity(i);
        }
