...
public class TelpPentingModel {
    String status, judul, key, waktu, icon;
    Integer jumlah_data, halaman_selanjutnya;
    Map<String, ListTelpPenting> data;

    public TelpPentingModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListTelpPenting> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListTelpPenting> getData() {
        return data;
    }

    public void setData(Map<String, ListTelpPenting> data) {
        this.data = data;
    }
}
