...
public class TampilPerdaByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_perda_by_jenis);

        toolbar = findViewById(R.id.perdaToolbaar);
        listView = (ListView) findViewById(R.id.listPerda);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilPerdaByJenis.this, DetilPerda.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilPerdaByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_perda");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<PerdaModel> call = api.cariPerdaByJenis(kategori);
        ...
        call.enqueue(new Callback<PerdaModel>() {
            ...
            public void onResponse(Call<PerdaModel> call, final Response<PerdaModel> response) {
                ...
                listView.setAdapter(new PerdaAdapter(TampilPerdaByJenis.this, R.layout.perda_adapter, list));
                Toast.makeText(TampilPerdaByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<PerdaModel> call, Throwable t) {
                Toast.makeText(TampilPerdaByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void loadmore(){
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<PerdaModel> a = api.loadMorePerda(String.valueOf(nextPage));
        a.enqueue(new Callback<PerdaModel>() {
