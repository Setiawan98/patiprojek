 ...
 */
public class TambahKoperasiFragment extends Fragment implements OnMapReadyCallback, LocationListener{


    public TambahKoperasiFragment() {
    ...
    public void addKoperasiWithGambar(){
        //defining a progress dialog to show while signing up
        final ProgressDialog progressDialog = new ProgressDialog(getContext());
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        ...
        MultipartBody.Part gambarKoperasi1=null;
        MultipartBody.Part gambarKoperasi2=null;
        MultipartBody.Part gambarKoperasi3=null;
        if(imageBytes1!=null)
        {
            gambarKoperasi1 = MultipartBody.Part.createFormData("gambar", "a.jpg", requestFile1);
            gambarKoperasiUtama = MultipartBody.Part.createFormData("gambarutama", "a.jpg", requestFile1);
            Log.d("masuk","1");
        }else{
            Log.d("nullImage","1");
        }
        if(imageBytes2!=null)
        {
            gambarKoperasi2 = MultipartBody.Part.createFormData("gambar2", "b.jpg", requestFile2);
            Log.d("masuk","2");
        }else{
            Log.d("nullImage","2");
        }
        if(imageBytes3!=null)
        {
            gambarKoperasi3 = MultipartBody.Part.createFormData("gambar3", "c.jpg", requestFile3);
            Log.d("masuk","3");
        }else{
            Log.d("nullImage","3");
        }

        Call<DetilKoperasiBaru> call = api.addDataKoperasiWithGambar(gambarKoperasi1,gambarKoperasi2,gambarKoperasi3,gambarKoperasiUtama,nama,telp,email,website,deskripsi,latitude,longitude,userId,value);
