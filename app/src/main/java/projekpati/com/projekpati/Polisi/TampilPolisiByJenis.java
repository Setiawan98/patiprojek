...
public class TampilPolisiByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_polisi_by_jenis);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilPolisiByJenis.this,DetilPolisi.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilPolisiByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_polisi");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<PolisiModel> call = api.cariPolisiByJenis(kategori);
        ...
        call.enqueue(new Callback<PolisiModel>() {
            ...
            public void onResponse(Call<PolisiModel> call, final Response<PolisiModel> response) {
                ...
                listView.setAdapter(new PolisiAdapter(TampilPolisiByJenis.this, R.layout.polisi_adapter, list));
                Toast.makeText(TampilPolisiByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<PolisiModel> call, Throwable t) {
                Toast.makeText(TampilPolisiByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
