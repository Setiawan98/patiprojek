...
import projekpati.com.projekpati.Tukang.DataSaringTukangActivity;
import projekpati.com.projekpati.Tukang.TukangAdapter;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class DataSaringKesehatanActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListKesehatan> list = new ArrayList<>();
    List<ListKesehatan> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_kesehatan);
...
//                startActivity(intent);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<KesehatanModel>() {
                ...
                public void onResponse(Call<KesehatanModel> call, final Response<KesehatanModel> response) {
                    ...
                    listView.setAdapter(new KesehatanAdapter(DataSaringKesehatanActivity.this, R.layout.kesehatan_adapter, list));
                    Toast.makeText(DataSaringKesehatanActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<KesehatanModel> call, Throwable t) {
                    Toast.makeText(DataSaringKesehatanActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<KesehatanModel> call = api.cariKesehatanbyAPI(namasaring);
            call.enqueue(new Callback<KesehatanModel>() {
                @Override
