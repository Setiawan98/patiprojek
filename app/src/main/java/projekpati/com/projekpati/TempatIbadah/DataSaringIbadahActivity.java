...
public class DataSaringIbadahActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListIbadah> list = new ArrayList<>();
    List<ListIbadah> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_ibadah);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringIbadahActivity.this, DetilIbadah.class);
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<IbadahModel>() {
                ...
                public void onResponse(Call<IbadahModel> call, final Response<IbadahModel> response) {
                    ...
                    listView.setAdapter(new IbadahAdapter(DataSaringIbadahActivity.this, R.layout.ibadah_adapter, list));
                    Toast.makeText(DataSaringIbadahActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<IbadahModel> call, Throwable t) {
                    Toast.makeText(DataSaringIbadahActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
