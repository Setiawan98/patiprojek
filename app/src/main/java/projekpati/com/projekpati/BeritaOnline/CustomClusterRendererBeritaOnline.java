...
public class CustomClusterRendererBeritaOnline extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererBeritaOnline(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
