...
public class LapakModel {
    ...
    Map<String, ListLapak> data;

    public LapakModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListLapak> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListLapak> getData() {
        return data;
    }

    public void setData(Map<String, ListLapak> data) {
        this.data = data;
    }
}
