...
public class DataSaringHotelActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListHotel> list = new ArrayList<>();
    List<ListHotel> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_hotel);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringHotelActivity.this, DetilHotel.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<HotelModel>() {
                ...
                public void onResponse(Call<HotelModel> call, final Response<HotelModel> response) {
                    ...
                    listView.setAdapter(new HotelAdapter(DataSaringHotelActivity.this, R.layout.hotel_adapter, list));
                    Toast.makeText(DataSaringHotelActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<HotelModel> call, Throwable t) {
                    Toast.makeText(DataSaringHotelActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<HotelModel> call = api.cariHotelbyAPI(namasaring);
            call.enqueue(new Callback<HotelModel>() {
                @Override
