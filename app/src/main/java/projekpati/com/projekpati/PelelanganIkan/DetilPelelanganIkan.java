...
public class DetilPelelanganIkan extends AppCompatActivity {
    ...
    float lat;
    float longt;
    LinearLayout listPelelanganIkan;
    LinearLayout linearDetil, linearJam;
    List<KomentarParent> list = new ArrayList<>();
    List<DetilPelelanganIkanBaru> Menu = new ArrayList<>();
    ...
    ImageView btnEdit;
    String userid, isi,waktu, nama,email,telp,website;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detil_pelelangan_ikan);
        ...
        listPelelanganIkan = findViewById(R.id.listPelelanganIkan);
        ...
        title.setText("Detil PelelanganIkan");
        ...
        id = bundle.getString("id_pelelangan_ikan");
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilPelelanganIkan.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else {
                    final Bundle bundle = getIntent().getExtras();
                    final String id = bundle.getString("id_pelelangan_ikan");
                    final float hasil = ratingstar.getRating();
                    isi = komentar.getText().toString();

                    API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
                    Call<postKomentar> call = api.addKomentar(id, "pelelangan_ikan", nama, email, telp, website, isi, String.valueOf(hasil), userid);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditPelelanganIkanActivity editPelelanganIkanActivity = new EditPelelanganIkanActivity();
                editPelelanganIkanActivity.setArguments(bundle);
                fragmentTransaction.replace(R.id.fragmentEdit, editPelelanganIkanActivity);
    ...
    public void listKomentar()
    {
        ...
        for(int i =size-1;i>=0;i--)
        {
            ...
            if(kp!=null)
            {
                ...
                listPelelanganIkan.addView(adapter);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasPelelanganIkan( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
        ...
        call.enqueue(new Callback<DetilPelelanganIkanModel>() {
            ...
            public void onResponse(Call<DetilPelelanganIkanModel> call, Response<DetilPelelanganIkanModel> response) {
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_pelelangan_ikan_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilPelelanganIkan.this,stringArray);
    ...
    public void getKomentar(){
        Toast.makeText(DetilPelelanganIkan.this.getApplicationContext(),id, Toast.LENGTH_SHORT).show();
        API api2 = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KomentarLengkap> call2 = api2.getKomentarPelelanganIkan(id);
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilPelelanganIkan.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listPelelanganIkan.addView(adapter,0);
                listPelelanganIkan.invalidate();
            }
        },2000);
