...
public class DetilKoperasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detil_koperasi);
        ...
        listKoperasi = findViewById(R.id.listKoperasi);
        ...
        id = bundle.getString("id_koperasi");
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilKoperasi.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else {
                    final Bundle bundle = getIntent().getExtras();
                    final String id = bundle.getString("id_koperasi");
                    final float hasil = ratingstar.getRating();
                    isi = komentar.getText().toString();

                    API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
                    Call<postKomentar> call = api.addKomentar(id, "koperasi", nama, email, telp, website, isi, String.valueOf(hasil), userid);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditKoperasiActivity editKoperasiActivity = new EditKoperasiActivity();
                editKoperasiActivity.setArguments(bundle);
                fragmentTransaction.replace(R.id.fragmentEdit, editKoperasiActivity);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasKoperasi( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
        ...
        call.enqueue(new Callback<DetilKoperasiModel>() {
            ...
            public void onResponse(Call<DetilKoperasiModel> call, Response<DetilKoperasiModel> response) {
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_koperasi_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilKoperasi.this,stringArray);
    ...
    public void getKomentar(){
        Toast.makeText(DetilKoperasi.this.getApplicationContext(),id, Toast.LENGTH_SHORT).show();
        API api2 = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KomentarLengkap> call2 = api2.getKomentarKoperasi(id);
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilKoperasi.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listKoperasi.addView(adapter,0);
                listKoperasi.invalidate();
            }
        },2000);
