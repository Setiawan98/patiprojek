...
public class TampilHotelByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_hotel_by_jenis);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilHotelByJenis.this, DetilHotel.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilHotelByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_hotel");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<HotelModel> call = api.cariHotelByJenis(kategori);
        ...
        call.enqueue(new Callback<HotelModel>() {
            ...
            public void onResponse(Call<HotelModel> call, final Response<HotelModel> response) {
                ...
                listView.setAdapter(new HotelAdapter(TampilHotelByJenis.this, R.layout.hotel_adapter, list));
                Toast.makeText(TampilHotelByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<HotelModel> call, Throwable t) {
                Toast.makeText(TampilHotelByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void loadmore(){
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<HotelModel> a = api.loadMoreHotel(String.valueOf(nextPage));
        a.enqueue(new Callback<HotelModel>() {
