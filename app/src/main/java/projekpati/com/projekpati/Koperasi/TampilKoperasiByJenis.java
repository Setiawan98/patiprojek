...
public class TampilKoperasiByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_koperasi_by_jenis);

        toolbar = findViewById(R.id.koperasiToolbar);
        listView = (ListView) findViewById(R.id.listKoperasi);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilKoperasiByJenis.this, DetilKoperasi.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilKoperasiByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_koperasi");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KoperasiModel> call = api.cariKoperasiByJenis(kategori);
        ...
        call.enqueue(new Callback<KoperasiModel>() {
            ...
            public void onResponse(Call<KoperasiModel> call, final Response<KoperasiModel> response) {
                ...
                listView.setAdapter(new KoperasiAdapter(TampilKoperasiByJenis.this, R.layout.koperasi_adapter, list));
                Toast.makeText(TampilKoperasiByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<KoperasiModel> call, Throwable t) {
                Toast.makeText(TampilKoperasiByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void loadmore(){
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KoperasiModel> a = api.loadMoreKoperasi(String.valueOf(nextPage));
        a.enqueue(new Callback<KoperasiModel>() {
