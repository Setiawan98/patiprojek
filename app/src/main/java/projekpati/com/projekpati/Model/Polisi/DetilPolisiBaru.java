...
public class DetilPolisiBaru {
    String id, ref_polisi_icon, ref_polisi_nama, ref_polisi_warna, rating, rating_jumlah, nama, telp, email, website, deskripsi, latitude, longitude, alamat, file, file_small, publish, hari_0, hari_1, hari_2, hari_3, hari_4, hari_5, hari_6;
    List<GambarPolisiDetil> gambar;

    public DetilPolisiBaru(String id, String ref_polisi_icon, String ref_polisi_nama, String ref_polisi_warna, String rating, String rating_jumlah, String nama, String telp, String email, String website, String deskripsi, String latitude, String longitude, String alamat, String file, String file_small, String publish, String hari_0, String hari_1, String hari_2, String hari_3, String hari_4, String hari_5, String hari_6, List<GambarPolisiDetil> gambar) {
        this.id = id;
    ...
    public List<GambarPolisiDetil> getGambar() {
        return gambar;
    }

    public void setGambar(List<GambarPolisiDetil> gambar) {
        this.gambar = gambar;
    }
}
