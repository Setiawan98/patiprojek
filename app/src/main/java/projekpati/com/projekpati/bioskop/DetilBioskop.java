...
import projekpati.com.projekpati.Model.Bioskop.GambarBioskopDetil;
...
import projekpati.com.projekpati.bioskop.EditBioskopActivity;
...
public class DetilBioskop extends AppCompatActivity {
    ...
    float lat;
    float longt;
    LinearLayout listBioskop;
    LinearLayout linearDetil, linearJam;
    List<KomentarParent> list = new ArrayList<>();
    List<DetilBioskopBaru> Menu = new ArrayList<>();
    List<GambarBioskopDetil> gambarList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detil_bioskop);
        ...
        listBioskop = findViewById(R.id.listBioskop);
        ...
        id = bundle.getString("id_bioskop");
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilBioskop.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else {
                    final Bundle bundle = getIntent().getExtras();
                    final String id = bundle.getString("id_bioskop");
                    final float hasil = ratingstar.getRating();
                    isi = komentar.getText().toString();

                    API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
                    Call<postKomentar> call = api.addKomentar(id, "bioskop", nama, email, telp, website, isi, String.valueOf(hasil), userid);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditBioskopActivity editBioskopActivity = new EditBioskopActivity();
                editBioskopActivity.setArguments(bundle);
                fragmentTransaction.replace(R.id.fragmentEdit, editBioskopActivity);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasBioskop( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
    ...
    public void getDataDetail(){
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<DetilBioskopModel> call = api.detailBioskop(id);

        call.enqueue(new Callback<DetilBioskopModel>() {
            @Override
            public void onResponse(Call<DetilBioskopModel> call, Response<DetilBioskopModel> response) {


                Log.w("ResponseAsu", new Gson().toJson(response.body()));
                title.setText(response.body().getJudul());
                refnama.setText(response.body().getData().getRef_bioskop_nama());
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_bioskop_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilBioskop.this,stringArray);
            ...
            @Override
            public void onFailure(Call<DetilBioskopModel> call, Throwable t) {
    ...
    public void getKomentar(){
        Toast.makeText(DetilBioskop.this.getApplicationContext(),id, Toast.LENGTH_SHORT).show();
        API api2 = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KomentarLengkap> call2 = api2.getKomentarBioskop(id);
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilBioskop.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listBioskop.addView(adapter,0);
                listBioskop.invalidate();
            }
        },2000);
