 ...
 */
public class TambahPendidikanFragment extends Fragment implements OnMapReadyCallback, LocationListener{


    public TambahPendidikanFragment() {
    ...
    public void addPendidikanWithGambar(){
        //defining a progress dialog to show while signing up
        final ProgressDialog progressDialog = new ProgressDialog(getContext());
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        ...
        MultipartBody.Part gambarPendidikan1=null;
        MultipartBody.Part gambarPendidikan2=null;
        MultipartBody.Part gambarPendidikan3=null;
        if(imageBytes1!=null)
        {
            gambarPendidikan1 = MultipartBody.Part.createFormData("gambar", "a.jpg", requestFile1);
            gambarPendidikanUtama = MultipartBody.Part.createFormData("gambarutama", "a.jpg", requestFile1);
            Log.d("masuk","1");
        }else{
            Log.d("nullImage","1");
        }
        if(imageBytes2!=null)
        {
            gambarPendidikan2 = MultipartBody.Part.createFormData("gambar2", "b.jpg", requestFile2);
            Log.d("masuk","2");
        }else{
            Log.d("nullImage","2");
        }
        if(imageBytes3!=null)
        {
            gambarPendidikan3 = MultipartBody.Part.createFormData("gambar3", "c.jpg", requestFile3);
            Log.d("masuk","3");
        }else{
            Log.d("nullImage","3");
        }

        Call<DetilPendidikanBaru> call = api.addDataPendidikanWithGambar(gambarPendidikan1,gambarPendidikan2,gambarPendidikan3,gambarPendidikanUtama,nama,telp,email,website,deskripsi,latitude,longitude,userId,value);
