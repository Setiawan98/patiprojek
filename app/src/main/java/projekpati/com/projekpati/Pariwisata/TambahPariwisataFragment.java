...
public class TambahPariwisataFragment extends Fragment implements OnMapReadyCallback, LocationListener {
    ...
    public void addKuliner(){
        ...
        Call<DetilPariwisataBaru> call = api.addDataPariwisata(nama,telp,email,website,deskripsi,latitude,longitude,hari_0,hari_1,hari_2,hari_3,hari_4,hari_5,hari_6,"0",value);
