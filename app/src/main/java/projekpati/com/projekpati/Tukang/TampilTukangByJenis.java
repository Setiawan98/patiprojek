...
public class TampilTukangByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_tukang_by_jenis);
...
//        });
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilTukangByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_tukang");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<TukangModel> call = api.cariTukangByJenis(kategori);
        ...
        call.enqueue(new Callback<TukangModel>() {
            ...
            public void onResponse(Call<TukangModel> call, final Response<TukangModel> response) {
                ...
                listView.setAdapter(new TukangAdapter(TampilTukangByJenis.this, R.layout.tukang_adapter, list));
                Toast.makeText(TampilTukangByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<TukangModel> call, Throwable t) {
                Toast.makeText(TampilTukangByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
