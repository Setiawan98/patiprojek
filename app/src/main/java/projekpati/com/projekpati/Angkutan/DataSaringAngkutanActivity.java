...
public class DataSaringAngkutanActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListAngkutan> list = new ArrayList<>();
    List<ListAngkutan> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_angkutan);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringAngkutanActivity.this, DetilAngkutan.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<AngkutanModel>() {
                ...
                public void onResponse(Call<AngkutanModel> call, final Response<AngkutanModel> response) {
                    ...
                    listView.setAdapter(new AngkutanAdapter(DataSaringAngkutanActivity.this, R.layout.activity_angkutan_adapter, list));
                    Toast.makeText(DataSaringAngkutanActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<AngkutanModel> call, Throwable t) {
                    Toast.makeText(DataSaringAngkutanActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<AngkutanModel> call = api.cariAngkutanbyAPI(namasaring);
            call.enqueue(new Callback<AngkutanModel>() {
                @Override
