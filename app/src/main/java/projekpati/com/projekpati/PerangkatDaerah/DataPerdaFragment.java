 ...
 */
public class DataPerdaFragment extends Fragment {
    ...
    ArrayList<ListPerda> listLatn = new ArrayList<ListPerda>();
    LinearLayout lp;
    MapView mapView;
    String apikey;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_data_perda, container, false);
        listView = (ListView) view.findViewById(R.id.listPerda);
    ...
    public void getAllBeritaOnline(){
        ...
        call.enqueue(new Callback<PerdaModel>() {
            ...
            public void onResponse(Call<PerdaModel> call, final Response<PerdaModel> response) {
                ...
                listView.setAdapter(new PerdaAdapter(getContext(), R.layout.perda_adapter, list));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getContext(), DetilPerda.class);
    ...
    public void loadMoreData(){
        ...
        call.enqueue(new Callback<PerdaModel>() {
            ...
            public void onResponse(Call<PerdaModel> call, final Response<PerdaModel> response) {
                ...
                PerdaAdapter adapter = new PerdaAdapter(getContext(), R.layout.perda_adapter, list);
