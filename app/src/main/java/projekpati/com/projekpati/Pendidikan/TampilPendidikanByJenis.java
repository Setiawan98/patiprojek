...
public class TampilPendidikanByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_pendidikan_by_jenis);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilPendidikanByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_pendidikan");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<PendidikanModel> call = api.cariPendidikanByJenis(kategori);
        ...
        call.enqueue(new Callback<PendidikanModel>() {
            ...
            public void onResponse(Call<PendidikanModel> call, final Response<PendidikanModel> response) {
                ...
                listView.setAdapter(new PendidikanAdapter(TampilPendidikanByJenis.this, R.layout.pendidikan_adapter, list));
                Toast.makeText(TampilPendidikanByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<PendidikanModel> call, Throwable t) {
                Toast.makeText(TampilPendidikanByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
