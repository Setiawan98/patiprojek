...
public class DetilKesehatanBaru {
    String id, ref_kesehatan_nama, ref_kesehatan_icon, ref_kesehatan_warna, rating, rating_jumlah, nama, telp, email, website, deskripsi, latitude, longitude, alamat, file, file_small, publish, hari_0, hari_1, hari_2, hari_3, hari_4, hari_5, hari_6;
    List<GambarKesehatanDetil> gambar;

    public DetilKesehatanBaru(String id, String ref_kesehatan_nama, String ref_kesehatan_icon, String ref_kesehatan_warna, String rating, String rating_jumlah, String nama, String telp, String email, String website, String deskripsi, String latitude, String longitude, String alamat, String file, String file_small, String publish, String hari_0, String hari_1, String hari_2, String hari_3, String hari_4, String hari_5, String hari_6, List<GambarKesehatanDetil> gambar) {
        this.id = id;
    ...
    public void setRef_kesehatan_nama(String ref_kesehatan_nama) {
        this.ref_kesehatan_nama = ref_kesehatan_nama;
    }
    ...
    public void setRef_kesehatan_icon(String ref_kesehatan_icon) {
        this.ref_kesehatan_icon = ref_kesehatan_icon;
    }
    ...
    public void setRef_kesehatan_warna(String ref_kesehatan_warna) {
        this.ref_kesehatan_warna = ref_kesehatan_warna;
    }
    ...
    public List<GambarKesehatanDetil> getGambar() {
        return gambar;
    }

    public void setGambar(List<GambarKesehatanDetil> gambar) {
        this.gambar = gambar;
    }
}
