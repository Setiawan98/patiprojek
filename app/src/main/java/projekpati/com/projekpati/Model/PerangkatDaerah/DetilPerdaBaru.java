...
public class DetilPerdaBaru {
    String id, ref_perangkat_daerah_icon, ref_perangkat_daerah_nama, ref_perangkat_daerah_warna, nama, alamat, email, telpon, website, deskripsi, rating_jumlah, rating, file, file_small, publish;
    List<GambarPerdaDetil> gambar;

    public DetilPerdaBaru(String id, String ref_perangkat_daerah_icon, String ref_perangkat_daerah_nama, String ref_perangkat_daerah_warna, String nama, String alamat, String email, String telpon, String website, String deskripsi, String rating_jumlah, String rating, String file, String file_small, String publish, List<GambarPerdaDetil> gambar) {
        this.id = id;
    ...
    public List<GambarPerdaDetil> getGambar() {
        return gambar;
    }

    public void setGambar(List<GambarPerdaDetil> gambar) {
        this.gambar = gambar;
    }
}
