...
public class TampilBeritaCetakByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_berita_cetak_by_jenis);

        toolbar = findViewById(R.id.beritaCetakToolbar);
        listView = (ListView) findViewById(R.id.listBeritaCetak);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilBeritaCetakByJenis.this, DetilBeritaCetak.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilBeritaCetakByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_berita_cetak");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<BeritaCetakModel> call = api.cariBeritaCetakByJenis(kategori);
        ...
        call.enqueue(new Callback<BeritaCetakModel>() {
            ...
            public void onResponse(Call<BeritaCetakModel> call, final Response<BeritaCetakModel> response) {
                ...
                listView.setAdapter(new BeritaCetakAdapter(TampilBeritaCetakByJenis.this, R.layout.berita_cetak_adapter, list));
                Toast.makeText(TampilBeritaCetakByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<BeritaCetakModel> call, Throwable t) {
                Toast.makeText(TampilBeritaCetakByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void loadmore(){
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<BeritaCetakModel> a = api.loadMoreBeritaCetak(String.valueOf(nextPage));
        a.enqueue(new Callback<BeritaCetakModel>() {
