 ...
 */
public class TambahHotelFragment extends Fragment implements OnMapReadyCallback, LocationListener{


    public TambahHotelFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tambah_hotel, container, false);
        vg=container;
        init(view);
        setSpinner();
    ...
    public void addHotel(){
        ...
        Call<DetilHotelBaru> call = api.addDataHotel(nama,telp,email,website,deskripsi,latitude,longitude,"0",value);
    ...
    public void addHotelWithGambar(){
        //defining a progress dialog to show while signing up
        final ProgressDialog progressDialog = new ProgressDialog(getContext());
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        ...
        MultipartBody.Part gambarHotel1=null;
        MultipartBody.Part gambarHotel2=null;
        MultipartBody.Part gambarHotel3=null;
        if(imageBytes1!=null)
        {
            gambarHotel1 = MultipartBody.Part.createFormData("gambar", "a.jpg", requestFile1);
            gambarHotelUtama = MultipartBody.Part.createFormData("gambarutama", "a.jpg", requestFile1);
            Log.d("masuk","1");
        }else{
            Log.d("nullImage","1");
        }
        if(imageBytes2!=null)
        {
            gambarHotel2 = MultipartBody.Part.createFormData("gambar2", "b.jpg", requestFile2);
            Log.d("masuk","2");
        }else{
            Log.d("nullImage","2");
        }
        if(imageBytes3!=null)
        {
            gambarHotel3 = MultipartBody.Part.createFormData("gambar3", "c.jpg", requestFile3);
            Log.d("masuk","3");
        }else{
            Log.d("nullImage","3");
        }

        Call<DetilHotelBaru> call = api.addDataHotelWithGambar(gambarHotel1,gambarHotel2,gambarHotel3,gambarHotelUtama,nama,telp,email,website,deskripsi,latitude,longitude,userId,value);
