...
public class TampilTelpPentingByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_telp_penting_by_jenis);

        toolbar = findViewById(R.id.beritaCetakToolbar);
        listView = (ListView) findViewById(R.id.listTelpPenting);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilTelpPentingByJenis.this, DetilTelpPenting.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilTelpPentingByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_telp_penting");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<TelpPentingModel> call = api.cariTelpPentingByJenis(kategori);
        ...
        call.enqueue(new Callback<TelpPentingModel>() {
            ...
            public void onResponse(Call<TelpPentingModel> call, final Response<TelpPentingModel> response) {
                ...
                listView.setAdapter(new TelpPentingAdapter(TampilTelpPentingByJenis.this, R.layout.telp_penting_adapter, list));
                Toast.makeText(TampilTelpPentingByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<TelpPentingModel> call, Throwable t) {
                Toast.makeText(TampilTelpPentingByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void loadmore(){
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<TelpPentingModel> a = api.loadMoreTelpPenting(String.valueOf(nextPage));
        a.enqueue(new Callback<TelpPentingModel>() {
