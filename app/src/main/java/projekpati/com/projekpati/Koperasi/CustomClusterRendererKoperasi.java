...
public class CustomClusterRendererKoperasi extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererKoperasi(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
