...
import projekpati.com.projekpati.BeritaOnline.BeritaOnlineAdapter;
...
public class TampilBeritaOnlineByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_berita_online_by_jenis);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilBeritaOnlineByJenis.this, DetilBeritaOnline.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilBeritaOnlineByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_beritaOnline");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<BeritaOnlineModel> call = api.cariBeritaOnlineByJenis(kategori);
        ...
        call.enqueue(new Callback<BeritaOnlineModel>() {
            ...
            public void onResponse(Call<BeritaOnlineModel> call, final Response<BeritaOnlineModel> response) {
                ...
                listView.setAdapter(new BeritaOnlineAdapter(TampilBeritaOnlineByJenis.this, R.layout.berita_online_adapter, list));
                Toast.makeText(TampilBeritaOnlineByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<BeritaOnlineModel> call, Throwable t) {
                Toast.makeText(TampilBeritaOnlineByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
