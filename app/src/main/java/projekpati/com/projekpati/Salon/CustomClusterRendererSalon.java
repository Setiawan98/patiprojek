...
public class CustomClusterRendererSalon extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererSalon(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
