...
public class DetilTukangBaru {
    String id, ref_tukang_nama, ref_tukang_icon, ref_tukang_warna, rating, rating_jumlah, nama, telp, email, website, deskripsi, latitude, longitude, alamat, file, file_small, publish, hari_0, hari_1, hari_2, hari_3, hari_4, hari_5, hari_6;
    List<GambarTukangDetil> gambar;

    public DetilTukangBaru(String id, String ref_tukang_nama, String ref_tukang_icon, String ref_tukang_warna, String rating, String rating_jumlah, String nama, String telp, String email, String website, String deskripsi, String latitude, String longitude, String alamat, String file, String file_small, String publish, String hari_0, String hari_1, String hari_2, String hari_3, String hari_4, String hari_5, String hari_6, List<GambarTukangDetil> gambar) {
        this.id = id;
    ...
    public void setRef_tukang_nama(String ref_tukang_nama) {
        this.ref_tukang_nama = ref_tukang_nama;
    }
    ...
    public void setRef_tukang_icon(String ref_tukang_icon) {
        this.ref_tukang_icon = ref_tukang_icon;
    }
    ...
    public void setRef_tukang_warna(String ref_tukang_warna) {
        this.ref_tukang_warna = ref_tukang_warna;
    }
    ...
    public List<GambarTukangDetil> getGambar() {
        return gambar;
    }

    public void setGambar(List<GambarTukangDetil> gambar) {
        this.gambar = gambar;
    }
}
