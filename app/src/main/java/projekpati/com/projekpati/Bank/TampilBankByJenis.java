...
import projekpati.com.projekpati.Bank.DetilBank;
import projekpati.com.projekpati.Bank.BankAdapter;
import projekpati.com.projekpati.Bank.TampilBankByJenis;
...
public class TampilBankByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_bank_by_jenis);

        toolbar = findViewById(R.id.bankToolbar);
        listView = (ListView) findViewById(R.id.listBank);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilBankByJenis.this, DetilBank.class);
                intent.putExtra("id_bank",list.get(position).getId());
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilBankByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_bank");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<BankModel> call = api.cariBankByJenis(kategori);
        ...
        call.enqueue(new Callback<BankModel>() {
            ...
            public void onResponse(Call<BankModel> call, final Response<BankModel> response) {
                ...
                listView.setAdapter(new BankAdapter(TampilBankByJenis.this, R.layout.bank_adapter, list));
                Toast.makeText(TampilBankByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<BankModel> call, Throwable t) {
                Toast.makeText(TampilBankByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void loadmore(){
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<BankModel> a = api.loadMoreBank(String.valueOf(nextPage));
        a.enqueue(new Callback<BankModel>() {
