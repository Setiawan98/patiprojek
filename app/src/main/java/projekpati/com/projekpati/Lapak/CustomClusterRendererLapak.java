...
public class CustomClusterRendererLapak extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererLapak(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
