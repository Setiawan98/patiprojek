...
public class CustomClusterRendererBank extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererBank(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
