...
public class DetilPariwisataBaru {
    String id, ref_pariwisata_nama, ref_pariwisata_icon, ref_pariwisata_warna, rating, rating_jumlah, nama, telp, email, website, deskripsi, latitude, longitude, alamat, file, file_small, publish, hari_0, hari_1, hari_2, hari_3, hari_4, hari_5, hari_6;
    List<GambarPariwisataDetil> gambar;

    public DetilPariwisataBaru(String id, String ref_pariwisata_nama, String ref_pariwisata_icon, String ref_pariwisata_warna, String rating, String rating_jumlah, String nama, String telp, String email, String website, String deskripsi, String latitude, String longitude, String alamat, String file, String file_small, String publish, String hari_0, String hari_1, String hari_2, String hari_3, String hari_4, String hari_5, String hari_6, List<GambarPariwisataDetil> gambar) {
        this.id = id;
    ...
    public void setRef_pariwisata_nama(String ref_pariwisata_nama) {
        this.ref_pariwisata_nama = ref_pariwisata_nama;
    }
    ...
    public void setRef_pariwisata_icon(String ref_pariwisata_icon) {
        this.ref_pariwisata_icon = ref_pariwisata_icon;
    }
    ...
    public void setRef_pariwisata_warna(String ref_pariwisata_warna) {
        this.ref_pariwisata_warna = ref_pariwisata_warna;
    }
    ...
    public List<GambarPariwisataDetil> getGambar() {
        return gambar;
    }

    public void setGambar(List<GambarPariwisataDetil> gambar) {
        this.gambar = gambar;
    }
}
