...
public class TampilVideoByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_video_by_jenis);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilVideoByJenis.this,DetilVideo.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilVideoByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        ...
        call.enqueue(new Callback<VideoModel>() {
            ...
            public void onResponse(Call<VideoModel> call, final Response<VideoModel> response) {
                ...
                listView.setAdapter(new VideoAdapter(TampilVideoByJenis.this, R.layout.video_adapter, list));
                Toast.makeText(TampilVideoByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<VideoModel> call, Throwable t) {
                Toast.makeText(TampilVideoByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
