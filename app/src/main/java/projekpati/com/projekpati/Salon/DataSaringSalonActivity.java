...
public class DataSaringSalonActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListSalon> list = new ArrayList<>();
    List<ListSalon> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_salon);

        toolbar = findViewById(R.id.salonToolbar);
        listView = (ListView) findViewById(R.id.listSalon);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringSalonActivity.this, DetilSalon.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<SalonModel>() {
                ...
                public void onResponse(Call<SalonModel> call, final Response<SalonModel> response) {
                    ...
                    listView.setAdapter(new SalonAdapter(DataSaringSalonActivity.this, R.layout.salon_adapter, list));
                    Toast.makeText(DataSaringSalonActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<SalonModel> call, Throwable t) {
                    Toast.makeText(DataSaringSalonActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<SalonModel> call = api.cariSalonbyAPI(namasaring);
            call.enqueue(new Callback<SalonModel>() {
                @Override
                public void onResponse(Call<SalonModel> call, Response<SalonModel> response) {
                    Map<String, ListSalon> data = response.body().getData();
    ...
    public void loadmore() {
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<SalonModel> a = api.loadMoreSalon(String.valueOf(nextPage));
