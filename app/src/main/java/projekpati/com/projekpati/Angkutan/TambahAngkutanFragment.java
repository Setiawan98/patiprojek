 ...
 */
public class TambahAngkutanFragment extends Fragment implements OnMapReadyCallback, LocationListener{


    public TambahAngkutanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tambah_angkutan, container, false);
        vg=container;
    ...
    public void addAngkutan(){
        ...
        Call<DetilAngkutanBaru> call = api.addDataAngkutan(nama,telp,email,website,deskripsi,latitude,longitude,"0",value);
    ...
    public void addAngkutanWithGambar(){
        //defining a progress dialog to show while signing up
        final ProgressDialog progressDialog = new ProgressDialog(getContext());
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        ...
        MultipartBody.Part gambarAngkutan1=null;
        MultipartBody.Part gambarAngkutan2=null;
        MultipartBody.Part gambarAngkutan3=null;
        if(imageBytes1!=null)
        {
            gambarAngkutan1 = MultipartBody.Part.createFormData("gambar", "a.jpg", requestFile1);
            gambarAngkutanUtama = MultipartBody.Part.createFormData("gambarutama", "a.jpg", requestFile1);
            Log.d("masuk","1");
        }else{
            Log.d("nullImage","1");
        }
        if(imageBytes2!=null)
        {
            gambarAngkutan2 = MultipartBody.Part.createFormData("gambar2", "b.jpg", requestFile2);
            Log.d("masuk","2");
        }else{
            Log.d("nullImage","2");
        }
        if(imageBytes3!=null)
        {
            gambarAngkutan3 = MultipartBody.Part.createFormData("gambar3", "c.jpg", requestFile3);
            Log.d("masuk","3");
        }else{
            Log.d("nullImage","3");
        }

        Call<DetilAngkutanBaru> call = api.addDataAngkutanWithGambar(gambarAngkutan1,gambarAngkutan2,gambarAngkutan3,gambarAngkutanUtama,nama,telp,email,website,deskripsi,latitude,longitude,userId,value);
