...
public class CustomClusterRendererKerjaan extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererKerjaan(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
