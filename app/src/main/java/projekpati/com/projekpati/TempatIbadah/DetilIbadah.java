...
public class DetilIbadah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detil_ibadah);
        ...
        listIbadah = findViewById(R.id.listIbadah);
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilIbadah.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    final Bundle bundle = getIntent().getExtras();
                    final String id = bundle.getString("id_ibadah");
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditIbadah editIbadah = new EditIbadah();
                editIbadah.setArguments(bundle);
                fragmentTransaction.replace(R.id.fragmentEdit, editIbadah);
        ...
        call.enqueue(new Callback<DetilIbadahModel>() {
            ...
            public void onResponse(Call<DetilIbadahModel> call, Response<DetilIbadahModel> response) {
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_ibadah_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilIbadah.this,stringArray);
    ...
    public void getKomentar(){
        ...
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilIbadah.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listIbadah.addView(adapter,0);
                listIbadah.invalidate();
            }
        },2000);
