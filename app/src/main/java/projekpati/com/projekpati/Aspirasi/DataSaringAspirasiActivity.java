...
public class DataSaringAspirasiActivity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListAspirasi> list = new ArrayList<>();
    List<ListAspirasi> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_aspirasi);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringAspirasiActivity.this, DetilAspirasi.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<AspirasiModel>() {
                ...
                public void onResponse(Call<AspirasiModel> call, final Response<AspirasiModel> response) {
                    ...
                    listView.setAdapter(new AspirasiAdapter(DataSaringAspirasiActivity.this, R.layout.aspirasi_adapter, list));
                    Toast.makeText(DataSaringAspirasiActivity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<AspirasiModel> call, Throwable t) {
                    Toast.makeText(DataSaringAspirasiActivity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<AspirasiModel> call = api.cariAspirasibyAPI(namasaring);
            call.enqueue(new Callback<AspirasiModel>() {
                @Override
