...
public class CustomClusterRendererIbadah extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererIbadah(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
