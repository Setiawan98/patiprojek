...
public class DetilBioskopBaru {
    String id, ref_bioskop_icon, ref_bioskop_nama, ref_bioskop_warna, rating, rating_jumlah, nama, telp, email, website, deskripsi, latitude, longitude, alamat, file, file_small, publish, hari_0, hari_1, hari_2, hari_3, hari_4, hari_5, hari_6;
    List<GambarBioskopDetil> gambar;

    public DetilBioskopBaru(String id, String ref_bioskop_icon, String ref_bioskop_nama, String ref_bioskop_warna, String rating, String rating_jumlah, String nama, String telp, String email, String website, String deskripsi, String latitude, String longitude, String alamat, String file, String file_small, String publish, String hari_0, String hari_1, String hari_2, String hari_3, String hari_4, String hari_5, String hari_6, List<GambarBioskopDetil> gambar) {
        this.id = id;
    ...
    public void setRef_bioskop_icon(String ref_bioskop_icon) {
        this.ref_bioskop_icon = ref_bioskop_icon;
    }
    ...
    public void setRef_bioskop_nama(String ref_bioskop_nama) {
        this.ref_bioskop_nama = ref_bioskop_nama;
    }
    ...
    public void setRef_bioskop_warna(String ref_bioskop_warna) {
        this.ref_bioskop_warna = ref_bioskop_warna;
    }
    ...
    public List<GambarBioskopDetil> getGambar() {
        return gambar;
    }

    public void setGambar(List<GambarBioskopDetil> gambar) {
        this.gambar = gambar;
    }
}
