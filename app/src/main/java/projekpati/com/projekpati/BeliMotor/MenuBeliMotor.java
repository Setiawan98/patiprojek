...
public class MenuBeliMotor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_beli_motor);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(id==R.id.beranda){
                    DataBeliMotorFragment first = new DataBeliMotorFragment();
                    openFragment(first);
                    //status =1;
                    ...
                    if(userid.equals(""))
                    {
                        Toast.makeText(MenuBeliMotor.this,"Silahkan login terlebih dahulu untuk tambah data",Toast.LENGTH_SHORT).show();
                    }
                    else {
...
//            startActivity(intent);
        ...
        {
            Intent i = new Intent(MenuBeliMotor.this, MainActivity.class);
            startActivity(i);
        }
