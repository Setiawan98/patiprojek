...
public class PanganModel {
    String status, judul, key, waktu, icon;
    Integer jumlah_data, halaman_selanjutnya;
    Map<String, ListPangan> data;

    public PanganModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListPangan> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public void setData(Map<String, ListPangan> data) {
        this.data = data;
    }
    ...
    public Map<String, ListPangan> getData() {
        return data;
    }
}
