...
public class SalonModel {
    ...
    Map<String, ListSalon> data;

    public SalonModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListSalon> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListSalon> getData() {
        return data;
    }

    public void setData(Map<String, ListSalon> data) {
        this.data = data;
    }
}
