...
public class DataSaringPelelanganIkan extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListPelelanganIkan> list = new ArrayList<>();
    List<ListPelelanganIkan> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_pelelangan_ikan);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringPelelanganIkan.this, DetilPelelanganIkan.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            call.enqueue(new Callback<PelelanganIkanModel>() {
                ...
                public void onResponse(Call<PelelanganIkanModel> call, final Response<PelelanganIkanModel> response) {
                    ...
                    listView.setAdapter(new PelelanganIkanAdapter(DataSaringPelelanganIkan.this, R.layout.pelelangan_ikan_adapter, list));
                    Toast.makeText(DataSaringPelelanganIkan.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<PelelanganIkanModel> call, Throwable t) {
                    Toast.makeText(DataSaringPelelanganIkan.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<PelelanganIkanModel> call = api.cariPelelanganIkanbyAPI(namasaring);
            call.enqueue(new Callback<PelelanganIkanModel>() {
                @Override
