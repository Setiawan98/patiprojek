...
public class CustomClusterRendererBioskop extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererBioskop(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
