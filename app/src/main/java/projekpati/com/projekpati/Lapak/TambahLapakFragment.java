 ...
 */
public class TambahLapakFragment extends Fragment implements OnMapReadyCallback, LocationListener {
    ...
    EditText eNama, eNomorTelp, eBarang, eHarga, eWebsite, eDeskripsi, eEmail;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tambah_lapak, container, false);
        vg=container;
    ...
    public void addLapakWithGambar(){
        ...
        MultipartBody.Part gambarLapak1=null;
        MultipartBody.Part gambarLapak2=null;
        MultipartBody.Part gambarLapak3=null;
        if(imageBytes1!=null)
        {
            gambarLapak1 = MultipartBody.Part.createFormData("gambar", "a.jpg", requestFile1);
            gambarLapakUtama = MultipartBody.Part.createFormData("gambarutama", "a.jpg", requestFile1);
            Log.d("masuk","1");
        }else{
            Log.d("nullImage","1");
        }
        if(imageBytes2!=null)
        {
            gambarLapak2 = MultipartBody.Part.createFormData("gambar2", "b.jpg", requestFile2);
            Log.d("masuk","2");
        }else{
            Log.d("nullImage","2");
        }
        if(imageBytes3!=null)
        {
            gambarLapak3 = MultipartBody.Part.createFormData("gambar3", "c.jpg", requestFile3);
            Log.d("masuk","3");
        }else{
            Log.d("nullImage","3");
        }

        Call<DetilLapakBaru> call = api.addDataLapakWithGambar(gambarLapak1,gambarLapak2,gambarLapak3,gambarLapakUtama,nama,telp,email,website,deskripsi,latitude,longitude,barang,harga,userId,value);
