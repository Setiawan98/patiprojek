...
public class MenuOlahraga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iconView.setImageResource(R.drawable.iconsport);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(id==R.id.beranda){
                    ...
                    if(userid.equals(""))
                    {
                        Toast.makeText(MenuOlahraga.this,"Silahkan login terlebih dahulu untuk tambah data",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
