...
public class CustomClusterRendererPelelanganIkan extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererPelelanganIkan(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
