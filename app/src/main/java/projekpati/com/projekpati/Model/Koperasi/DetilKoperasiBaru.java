...
public class DetilKoperasiBaru {
    String id, ref_koperasi_icon, ref_koperasi_nama, ref_koperasi_warna, rating, rating_jumlah, nama, telp, email, website, deskripsi, latitude, longitude, alamat, file, file_small, publish, hari_0, hari_1, hari_2, hari_3, hari_4, hari_5, hari_6;
    List<GambarKoperasiDetil> gambar;

    public DetilKoperasiBaru(String id, String ref_koperasi_icon, String ref_koperasi_nama, String ref_koperasi_warna, String rating, String rating_jumlah, String nama, String telp, String email, String website, String deskripsi, String latitude, String longitude, String alamat, String file, String file_small, String publish, String hari_0, String hari_1, String hari_2, String hari_3, String hari_4, String hari_5, String hari_6, List<GambarKoperasiDetil> gambar) {
        this.id = id;
    ...
    public void setRef_koperasi_icon(String ref_koperasi_icon) {
        this.ref_koperasi_icon = ref_koperasi_icon;
    }
    ...
    public void setRef_koperasi_nama(String ref_koperasi_nama) {
        this.ref_koperasi_nama = ref_koperasi_nama;
    }
    ...
    public void setRef_koperasi_warna(String ref_koperasi_warna) {
        this.ref_koperasi_warna = ref_koperasi_warna;
    }
    ...
    public List<GambarKoperasiDetil> getGambar() {
        return gambar;
    }

    public void setGambar(List<GambarKoperasiDetil> gambar) {
        this.gambar = gambar;
    }
}
