 ...
 */
public class TambahOlahragaFragment extends Fragment implements OnMapReadyCallback, LocationListener {


    public TambahOlahragaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tambah_olahraga, container, false);
        vg=container;
        ...
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(eNama.getText().toString().equals(""))
                {
                    ...
                    Toast.makeText(getContext(),"*Nama Tempat Olahraga tidak bole kosong",Toast.LENGTH_SHORT).show();
                }
                else {
                    addOlahragaWithGambar();
                }
            }
        });
    ...
    public void addOlahragaWithGambar(){
        ...
        MultipartBody.Part gambarOlahraga1=null;
        MultipartBody.Part gambarOlahraga2=null;
        MultipartBody.Part gambarOlahraga3=null;
        if(imageBytes1!=null)
        {
            gambarOlahraga1 = MultipartBody.Part.createFormData("gambar", "a.jpg", requestFile1);
            gambarOlahragaUtama = MultipartBody.Part.createFormData("gambarutama", "a.jpg", requestFile1);
            Log.d("masuk","1");
        }else{
            Log.d("nullImage","1");
        }
        if(imageBytes2!=null)
        {
            gambarOlahraga2 = MultipartBody.Part.createFormData("gambar2", "b.jpg", requestFile2);
            Log.d("masuk","2");
        }else{
            Log.d("nullImage","2");
        }
        if(imageBytes3!=null)
        {
            gambarOlahraga3 = MultipartBody.Part.createFormData("gambar3", "c.jpg", requestFile3);
            Log.d("masuk","3");
        }else{
            Log.d("nullImage","3");
        }

        Call<DetilOlahragaBaru> call = api.addDataOlahragaWithGambar(gambarOlahraga1,gambarOlahraga2,gambarOlahraga3,gambarOlahragaUtama,nama,telp,email,website,deskripsi,latitude,longitude,userId,value);
