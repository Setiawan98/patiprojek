...
public class DetilLapak extends AppCompatActivity {
    TextView textNama, textHarga, textBarang, textAlamat, textTelepon, textDeskripsi, textEmail, textWebsite, refnama, ratingsum, ratingpeople;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textBarang = findViewById(R.id.mBarang);
        listLapak = findViewById(R.id.listLapak);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasLapak( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
    ...
    public void getDataDetail(){
        ...
        call.enqueue(new Callback<DetilLapakModel>() {
            ...
            public void onResponse(Call<DetilLapakModel> call, Response<DetilLapakModel> response) {
                ...
                textBarang.setText(response.body().getData().getBarang());
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_lapak_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilLapak.this,stringArray);
    ...
    public void getKomentar(){
        ...
        Call<KomentarLengkap> call2 = api2.getKomentarLapak(id);
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listLapak.addView(adapter,0);
                listLapak.invalidate();
            }
        },2000);
