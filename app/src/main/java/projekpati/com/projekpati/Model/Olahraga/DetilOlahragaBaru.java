...
public class DetilOlahragaBaru {
    String id, ref_olahraga_icon, ref_olahraga_nama, ref_olahraga_warna, rating, rating_jumlah, nama, telp, email, website, deskripsi, latitude, longitude, alamat, file, file_small, publish, hari_0, hari_1, hari_2, hari_3, hari_4, hari_5, hari_6;
    List<GambarOlahragaDetil> gambar;

    public DetilOlahragaBaru(String id, String ref_olahraga_icon, String ref_olahraga_nama, String ref_olahraga_warna, String rating, String rating_jumlah, String nama, String telp, String email, String website, String deskripsi, String latitude, String longitude, String alamat, String file, String file_small, String publish, String hari_0, String hari_1, String hari_2, String hari_3, String hari_4, String hari_5, String hari_6, List<GambarOlahragaDetil> gambar) {
        this.id = id;
    ...
    public List<GambarOlahragaDetil> getGambar() {
        return gambar;
    }

    public void setGambar(List<GambarOlahragaDetil> gambar) {
        this.gambar = gambar;
    }
}
