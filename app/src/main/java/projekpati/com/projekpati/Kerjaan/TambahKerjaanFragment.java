...
public class TambahKerjaanFragment  extends Fragment implements OnMapReadyCallback, LocationListener {
    ...
    public void addKuliner(){
        ...
        String kantor = eKantor.getText().toString();
        String gaji = eGaji.getText().toString();
        String pengalaman = ePengalaman.getText().toString();
        ...
        Call<DetilKerjaanBaru> call = api.addDataKerjaan(nama,telp,email,kantor,gaji,pengalaman,website,deskripsi,latitude,longitude,"0",value);
