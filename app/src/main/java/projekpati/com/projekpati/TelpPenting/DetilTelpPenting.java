...
import projekpati.com.projekpati.TelpPenting.DetilTelpPenting;
import projekpati.com.projekpati.Kuliner.ViewPagerAdapter;
import projekpati.com.projekpati.Model.TelpPenting.DetilTelpPentingBaru;
...
public class DetilTelpPenting extends AppCompatActivity {
    ...
    LinearLayout listTelpPenting;

    List<KomentarParent> list = new ArrayList<>();
    List<DetilTelpPentingBaru> Menu = new ArrayList<>();
    List<GambarTelpPentingDetil> gambarList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detil_telp_penting);
        ...
        listTelpPenting = findViewById(R.id.listTelpPenting);
        ...
        title.setText("Detil TelpPenting");
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilTelpPenting.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Log.d("clicked","1");
                    ...
                    Call<postKomentar> call = api.addKomentar( id, "telp_penting",nama, email, telp, website, isi, String.valueOf(hasil), userid);
    ...
    public void listKomentar()
    {
        ...
        for(int i =size-1;i>=0;i--)
        {
            ...
            if(kp!=null)
            {
                ...
                listTelpPenting.addView(adapter);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasTelpPenting( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
    ...
    public void getDataDetail(){
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<DetilTelpPentingModel> call = api.detailTelpPenting(id);

        call.enqueue(new Callback<DetilTelpPentingModel>() {
            @Override
            public void onResponse(Call<DetilTelpPentingModel> call, Response<DetilTelpPentingModel> response) {


                Log.w("ResponseAsu", new Gson().toJson(response.body()));
                title.setText(response.body().getJudul());
                refnama.setText(response.body().getData().getRef_telp_penting_nama());
                mTime.setText(response.body().getData().getNotelp());
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_telp_penting_img();
                    }
            ...
            @Override
            public void onFailure(Call<DetilTelpPentingModel> call, Throwable t) {
    ...
    public void getKomentar(){
        ...
        Toast.makeText(DetilTelpPenting.this.getApplicationContext(),id, Toast.LENGTH_SHORT).show();
        API api2 = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KomentarLengkap> call2 = api2.getKomentarTelpPenting(id);
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilTelpPenting.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listTelpPenting.addView(adapter,0);
                listTelpPenting.invalidate();
            }
        },2000);
