...
import projekpati.com.projekpati.BeritaOnline.DetilBeritaOnline;
...
public class DetilBeritaOnline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detil_berita_online);
        ...
        toolbar = (Toolbar) findViewById(R.id.beritaOnlineToolbar);
        ...
        title.setText("Detil BeritaOnline");
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilBeritaOnline.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else {
                    Log.d("clicked", "1");
                    final Bundle bundle = getIntent().getExtras();
    ...
    public void listKomentar()
    {
        ...
        for(int i =size-1;i>=0;i--)
        {
            ...
            if(kp!=null)
            {
                ...
                listBeritaOnline.addView(adapter);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasBeritaOnline( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
    ...
    public void getDataDetail(){
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<DetilBeritaOnlineModel> call = api.detailBeritaOnline(id);

        call.enqueue(new Callback<DetilBeritaOnlineModel>() {
            @Override
            public void onResponse(Call<DetilBeritaOnlineModel> call, Response<DetilBeritaOnlineModel> response) {
                ...
                textNama.setText(response.body().getData().getJudul());
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_beritaOnline_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilBeritaOnline.this,stringArray);
            ...
            @Override
            public void onFailure(Call<DetilBeritaOnlineModel> call, Throwable t) {
    ...
    public void getKomentar(){
        ...
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilBeritaOnline.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listBeritaOnline.addView(adapter,0);
                listBeritaOnline.invalidate();
            }
        },2000);
