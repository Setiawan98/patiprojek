...
public class TampilAspirasiByJenis extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_aspirasi_by_jenis);

        toolbar = findViewById(R.id.aspirasiToolbar);
        listView = (ListView) findViewById(R.id.listAspirasi);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TampilAspirasiByJenis.this,DetilAspirasi.class);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (nextPage==0){
                            Toast.makeText(TampilAspirasiByJenis.this, "No More Data",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadmore();
    ...
    public void getAllData(){
        final Bundle bundle = getIntent().getExtras();
        final String kategori = bundle.getString("id_aspirasi");

        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<AspirasiModel> call = api.cariAspirasiByJenis(kategori);
        ...
        call.enqueue(new Callback<AspirasiModel>() {
            ...
            public void onResponse(Call<AspirasiModel> call, final Response<AspirasiModel> response) {
                ...
                listView.setAdapter(new AspirasiAdapter(TampilAspirasiByJenis.this, R.layout.aspirasi_adapter, list));
                Toast.makeText(TampilAspirasiByJenis.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }

            @Override
            public void onFailure(Call<AspirasiModel> call, Throwable t) {
                Toast.makeText(TampilAspirasiByJenis.this.getApplicationContext(),t.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void loadmore(){
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<AspirasiModel> a = api.loadMoreAspirasi(String.valueOf(nextPage));
