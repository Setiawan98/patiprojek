...
public class PolisiModel {
    String status, judul, key, waktu, icon;
    Integer jumlah_data, halaman_selanjutnya;
    Map<String, ListPolisi> data;

    public PolisiModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListPolisi> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListPolisi> getData() {
        return data;
    }

    public void setData(Map<String, ListPolisi> data) {
        this.data = data;
    }
}
