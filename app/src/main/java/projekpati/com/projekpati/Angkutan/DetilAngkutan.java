...
public class DetilAngkutan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detil_angkutan);
        ...
        listAngkutan = findViewById(R.id.listAngkutan);
        ...
        id = bundle.getString("id_angkutan");
        ...
        btnKomen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(userid.equals(""))
                {
                    Toast.makeText(DetilAngkutan.this,"Silahkan login terlebih dahulu untuk tambah komentar",Toast.LENGTH_SHORT).show();
                }
                else {
                    final Bundle bundle = getIntent().getExtras();
                    final String id = bundle.getString("id_angkutan");
                    final float hasil = ratingstar.getRating();
                    isi = komentar.getText().toString();

                    API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
                    Call<postKomentar> call = api.addKomentar(id, "angkutan", nama, email, telp, website, isi, String.valueOf(hasil), userid);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditAngkutanActivity editAngkutanActivity = new EditAngkutanActivity();
                editAngkutanActivity.setArguments(bundle);
                fragmentTransaction.replace(R.id.fragmentEdit, editAngkutanActivity);
    ...
    public void addBalas(String id, String nama, String email, String telp, String website, String isi, String parentID, String userid)
    {
        ...
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<postKomentar> call = api.addKomentarBalasAngkutan( id, nama, email, telp, website, parentID, isi , userid);
        call.enqueue(new Callback<postKomentar>() {
            @Override
            public void onResponse(Call<postKomentar> call, Response<postKomentar> response) {
            }
        ...
        call.enqueue(new Callback<DetilAngkutanModel>() {
            ...
            public void onResponse(Call<DetilAngkutanModel> call, Response<DetilAngkutanModel> response) {
                ...
                else
                {
                    ...
                    {
                        stringArray[i] = gambarList.get(i).getFile_angkutan_img();
                    }



                }
                ViewPagerAdapter adapter = new ViewPagerAdapter(DetilAngkutan.this,stringArray);
    ...
    public void getKomentar(){
        Toast.makeText(DetilAngkutan.this.getApplicationContext(),id, Toast.LENGTH_SHORT).show();
        API api2 = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<KomentarLengkap> call2 = api2.getKomentarAngkutan(id);
        call2.enqueue(new Callback<KomentarLengkap>() {
            ...
            public void onResponse(Call<KomentarLengkap> call, Response<KomentarLengkap> response) {
                ...
                Toast.makeText(DetilAngkutan.this.getApplicationContext(),"Sukses", Toast.LENGTH_SHORT).show();
            }
    ...
    public void addViewKomentar(final String id, final String nama, final String waktu, final String telp, final String email, final String website, String isi, final String pID, Float hasil){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                listAngkutan.addView(adapter,0);
                listAngkutan.invalidate();
            }
        },2000);
