...
public class CustomClusterRendererAspirasi extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererAspirasi(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
