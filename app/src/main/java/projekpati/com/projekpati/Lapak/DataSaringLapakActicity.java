...
public class DataSaringLapakActicity extends AppCompatActivity {
    ListView listView;
    Integer nextPage = 1;
    List<ListLapak> list = new ArrayList<>();
    List<ListLapak> listsaring = new ArrayList<>();
    Toolbar toolbar;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_saring_lapak_acticity);

        toolbar = findViewById(R.id.lapakToolbar);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DataSaringLapakActicity.this, DetilLapak.class);
    ...
    public void getAllData() {
        ...
        if(namasaring.equals(""))
        {
            ...
            Call<LapakModel> call = api.tampilSemuaLapak();

            call.enqueue(new Callback<LapakModel>() {
                @Override
                public void onResponse(Call<LapakModel> call, final Response<LapakModel> response) {
                    Map<String, ListLapak> data = response.body().getData();
                    ...
                    listView.setAdapter(new LapakAdapter(DataSaringLapakActicity.this, R.layout.lapak_adapter, list));
                    Toast.makeText(DataSaringLapakActicity.this.getApplicationContext(), "Sukses", Toast.LENGTH_SHORT).show();
                ...
                @Override
                public void onFailure(Call<LapakModel> call, Throwable t) {
                    Toast.makeText(DataSaringLapakActicity.this.getApplicationContext(), t.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
            Call<LapakModel> call = api.cariLapakbyAPI(namasaring);
            call.enqueue(new Callback<LapakModel>() {
                @Override
                public void onResponse(Call<LapakModel> call, Response<LapakModel> response) {
                    Map<String, ListLapak> data = response.body().getData();
    ...
    public void loadmore() {
        API api = RetrofitClientInstance.getRetrofitInstance().create(API.class);
        Call<LapakModel> a = api.loadMoreLapak(String.valueOf(nextPage));
        a.enqueue(new Callback<LapakModel>() {
