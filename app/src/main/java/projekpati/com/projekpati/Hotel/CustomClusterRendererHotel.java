...
public class CustomClusterRendererHotel extends DefaultClusterRenderer<MyItem> {
    private final IconGenerator iconGenerator;
    private final Context context;

    public CustomClusterRendererHotel(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
