...
public class OtomotifModel {
    String status, judul, key, waktu, icon;
    Integer jumlah_data, halaman_selanjutnya;
    Map<String, ListOtomotif> data;

    public OtomotifModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListOtomotif> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListOtomotif> getData() {
        return data;
    }

    public void setData(Map<String, ListOtomotif> data) {
        this.data = data;
    }
}
