...
public class DetilHotelBaru {
    String id, ref_hotel_icon, ref_hotel_nama, ref_hotel_warna, rating, rating_jumlah, nama, telp, email, website, deskripsi, latitude, longitude, alamat, file, file_small, publish, hari_0, hari_1, hari_2, hari_3, hari_4, hari_5, hari_6;
    List<GambarHotelDetil> gambar;

    public DetilHotelBaru(String id, String ref_hotel_icon, String ref_hotel_nama, String ref_hotel_warna, String rating, String rating_jumlah, String nama, String telp, String email, String website, String deskripsi, String latitude, String longitude, String alamat, String file, String file_small, String publish, String hari_0, String hari_1, String hari_2, String hari_3, String hari_4, String hari_5, String hari_6, List<GambarHotelDetil> gambar) {
        this.id = id;
    ...
    public void setRef_hotel_nama(String ref_hotel_nama) {
        this.ref_hotel_nama = ref_hotel_nama;
    }
    ...
    public void setRef_hotel_warna(String ref_hotel_warna) {
        this.ref_hotel_warna = ref_hotel_warna;
    }
    ...
    public void setRef_hotel_icon(String ref_hotel_icon) {
        this.ref_hotel_icon = ref_hotel_icon;
    }
    ...
    public List<GambarHotelDetil> getGambar() {
        return gambar;
    }

    public void setGambar(List<GambarHotelDetil> gambar) {
        this.gambar = gambar;
    }
}
