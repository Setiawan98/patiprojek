...
public class DetilAngkutanBaru {
    String id, ref_angkutan_icon, ref_angkutan_nama, ref_angkutan_warna, rating, rating_jumlah, nama, telp, email, website, deskripsi, latitude, longitude, alamat, file, file_small, publish, hari_0, hari_1, hari_2, hari_3, hari_4, hari_5, hari_6;
    List<GambarAngkutanDetil> gambar;

    public DetilAngkutanBaru(String id, String ref_angkutan_icon, String ref_angkutan_nama, String ref_angkutan_warna, String rating, String rating_jumlah, String nama, String telp, String email, String website, String deskripsi, String latitude, String longitude, String alamat, String file, String file_small, String publish, String hari_0, String hari_1, String hari_2, String hari_3, String hari_4, String hari_5, String hari_6, List<GambarAngkutanDetil> gambar) {
        this.id = id;
    ...
    public List<GambarAngkutanDetil> getGambar() {
        return gambar;
    }
    ...
    public void setRef_angkutan_icon(String ref_angkutan_icon) {
        this.ref_angkutan_icon = ref_angkutan_icon;
    }

    public void setRef_angkutan_nama(String ref_angkutan_nama) {
        this.ref_angkutan_nama = ref_angkutan_nama;
    }

    public void setRef_angkutan_warna(String ref_angkutan_warna) {
        this.ref_angkutan_warna = ref_angkutan_warna;
    }
    ...
    public void setGambar(List<GambarAngkutanDetil> gambar) {
        this.gambar = gambar;
    }
}
