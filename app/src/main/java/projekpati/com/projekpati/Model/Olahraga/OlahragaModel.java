...
public class OlahragaModel {
    ...
    Map<String, ListOlahraga> data;

    public OlahragaModel(String status, String judul, String key, String waktu, String icon, Integer jumlah_data, Integer halaman_selanjutnya, Map<String, ListOlahraga> data) {
        this.status = status;
        this.judul = judul;
        this.key = key;
        this.waktu = waktu;
    ...
    public Map<String, ListOlahraga> getData() {
        return data;
    }

    public void setData(Map<String, ListOlahraga> data) {
        this.data = data;
    }
}
